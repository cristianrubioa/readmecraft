...
export const styles = {
  ...
  buttonTransparent:
    'bg-transparent text-slate-900 dark:text-slate-100 border border-slate-300 dark:border-slate-600 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all',
  buttonDisabled: 'disabled:opacity-50 disabled:cursor-not-allowed',
  input:
    'border border-slate-300 dark:border-slate-600 rounded-2xl backdrop-blur-lg bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 disabled:opacity-60 disabled:cursor-not-allowed transition-all focus:outline-none focus:ring-2 focus:ring-slate-400 dark:focus:ring-slate-600',
  text: {
