  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-3 w-full max-w-3xl">
      <input
        ...
        disabled={loading}
        className="flex-1 min-w-0 px-4 sm:px-6 py-5 text-sm sm:text-xl border border-slate-300 dark:border-slate-600 rounded-2xl backdrop-blur-lg bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 disabled:opacity-60 disabled:cursor-not-allowed transition-all focus:outline-none focus:ring-2 focus:ring-slate-400 dark:focus:ring-slate-600"
      />
      <button
        type="submit"
        disabled={loading}
